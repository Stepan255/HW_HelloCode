...
1. namberA;
2. namber1 = namberA / 100;
3. namber2 = namberA % 10;
4. resalt = namber1 * 10 + namber2;

13. Выяснить, кратно ли число заданному, если нет, вывести остаток.
namberA
namberB
namberA % namberB == 0 - кратно

1. namberA
2. namberB
3. namberA % namberB (19 % 10 = 9)

14. Найти третью цифру числа или сообщить, что её нет
123456

namberA / 100 == 0 - нет 3 цифры

namberA % 1000 / 10 - третья цифра числа
